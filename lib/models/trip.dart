...
class Trip {
  ...
  final List<String> activities;  // Aktivitäten, die während der Reise verfügbar sind
  final List<String> program;  // Detailliertes Programm oder Tagesordnung der Reise
